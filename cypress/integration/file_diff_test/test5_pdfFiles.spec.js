...
const fileName1 = testParameters.pdfFile_3kB
const fileType_mimeType1 = 'application/pdf'
// const fileInput1 = '[name="fileInput1"]'

const fileName2 = testParameters.pdfFile_500kB
const fileType_mimeType2 = 'application/pdf'
...
describe('Upload and compare .pdf files', () => {
    ...
    it('Compapre two different pdf files of small sizes', () => {
        ...
        it('Upload the same pdf file for both display areas', () => {
